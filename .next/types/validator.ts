...
// Validate ../../app/api/send_message/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/send_message">> = Specific
  const handler = {} as typeof import("../../app/api/send_message/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
